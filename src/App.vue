<template>
  <div class="container container-lg">
    <nav class="bg-primary bg-subtle p-3 text-light text-center">
      <h1>Teste Pratico - Dev. Unigran Capital</h1>
    </nav>
    ...
    <div
      ...
      class="mx-auto p-4 shadow-lg border-primary rounded"
        ...
        <div class="modal-content">
          <div class="modal-header">
            <div class="modal-title">
              <h4 class="text-primary text-primary">{{ user & user.id ? "Editar" : "Adicionar"}} usuário </h4>
            </div>
            <button
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <div class="modal-title">
              <h4 class="text-danger">
                <i class="fas fa info align-center text-danger"></i>
                Atenção
              </h4>
            </div>
          ...
          <div class="modal-footer">
            <button class="btn btn-light" data-bs-dismiss="modal" @click="isModalDelete = false">Cancelar</button>
            <button class="btn btn-danger" data-bs-dismiss="modal" @click="isModalDelete = false">Deletar</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <table class="table table-striped table-hover table-bordered">
      <thead>
        <tr class="align-center bg-primary text-light text-center">
          <th>ID</th>
          <th>NOME</th>
          <th>CPF</th>
          <th>TELEFONE</th>
      ...
      <tbody>
        <tr class="text-center" v-for="user in users">
          ...
          <td>
            <a href="#" class="btn btn-primary text-light" @click="editUser(user)">
              <i class="fas fa-pencil-alt"></i>
            </a>
          </td>
          <td>
            <a href="#" class="btn btn-danger text-light" @click="deleteUser(user)">
